...
class OrderController {
    async createOrder(req, res) {
        try {
            const { quotation_id, customer_name, email, phone, shipping_address, 
            ...
            try {
                ...
                const [result] = await connection.query(
                    `INSERT INTO orders (order_id, quotation_id, customer_name, email, phone, 
                     ...
                     VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)`,
                    [orderId, quotation_id || null, customer_name, email || null, 
                     phone || null, shipping_address || null, total_amount, req.user.id, notes || null]
                );
